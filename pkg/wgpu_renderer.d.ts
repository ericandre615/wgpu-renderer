...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h104f27a9e128a72c: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hfb3034f105992657: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h72cc83117c36e360: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha7032d35c9586ff9: (a: number, b: number, c: number) => void;
