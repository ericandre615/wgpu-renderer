...
export function wasm_bindgen__convert__closures__invoke1_mut__h024df5e104663a16(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h7946c3829525e6fa(a: number, b: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha3b6d5695259bd27(a: number, b: number, c: number): void;
